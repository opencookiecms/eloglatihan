...
$route['kursus/qrgenerate/(:num)/(:num)'] = 'Maincontroller/generateQR/$1/$2';
$route['kursus/pegesahan/(:num)/:num)'] = 'Maincontroller/pegesahanid/$1/$2';
$route['kursus/daftar-kursus'] = 'Maincontroller/addKursus';
$route['kursus/add_user/(:num)'] = 'Maincontroller/adduserkursus/$1';
